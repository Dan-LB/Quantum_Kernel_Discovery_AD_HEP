...
my_allowed_operations = ['IX', 'IY', 'IZ', 'XY', 'XZ', 'YZ']
...
class TightKernelEnvironment(Environment):
    ...
    def __init__(self, initial_kernel: Kernel, X: np.ndarray, y: np.ndarray, ke: KernelEvaluator, bw_possible = 1):
        """
        Initialization
    ...
    def unpack_action(self, action):
        ...
        bw_index = int(action % self.bw)+1

        print("Sto stampando bw_index")
        print(bw_index)
